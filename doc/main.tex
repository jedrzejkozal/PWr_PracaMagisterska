...
\end{tikzpicture}
\caption{Schemat działania propagacji wstecznej w czasie.} Czarnym kolorem zaznaczono przepływ informacji przy obliczaniu aktywacji sieci. Czerwonym kolorem zaznaczono przepływ informacji przy zastosowaniu wstecznej propagacji błędu.
	\label{fig:rnn}
\end{figure}
...
\begin{equation}
	\frac{\partial \mathcal{E}}{\partial \Theta} = \sum_{1 \leq t \leq T} \frac{\partial \mathcal{E}_t}{\partial \Theta}
\end{equation}

\begin{equation}
	\frac{\partial \mathcal{E}_t}{\partial \Theta} = \sum_{1 \leq k \leq t} (\frac{\partial \mathcal{E}_t}{\partial \bb{h}_t} \frac{\partial \bb{h}_t}{\partial \bb{h}_k} \frac{\partial \bb{h}_k}{\partial \Theta})
\end{equation}
