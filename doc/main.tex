...
W niniejszym rozdziale przedstawiono wyniki uzyskane zgodnie z przyjętą i wcześniej opisaną metyką.
\begin{table}
\centering
...
\begin{tabular}{ |c|c|c|c|c| } 
 ...
 \multicolumn{1}{l}{ReNet} & \multicolumn{1}{l}{lr} & \multicolumn{1}{l}{l1} & \multicolumn{1}{l|}{l2} \\\cline{2-5} &
...
\begin{tabular}{ |c|c|c|c|c|c| } 
 \hline
 dataset & algorytm & \makecell{l. warstw\\ ekstrakcji} & \makecell{l. neuronów\\ w warstwach\\ ekstrakcji} & \makecell{rozm.\\patchy} & dropout \\ 
 \hline
 \hline
 \multirow{3}{*}{\makecell{Chest X-Ray\\ Images (Pneumonia)}} &
 \multicolumn{1}{l}{ReNet} & \multicolumn{1}{l}{lr} & \multicolumn{1}{l}{l1} & \multicolumn{1}{l}{l2} & \multicolumn{1}{l|}{ex} \\\cline{2-6} &
...
\begin{tabular}{ |c|c|c|c| } 
 ...
 \hline
 \multirow{3}{*}{\makecell{Chest X-Ray\\ Images (Pneumonia)}} &
 \multicolumn{1}{l}{ReNet} & \multicolumn{1}{l}{l n} & \multicolumn{1}{l|}{drop} \\\cline{2-4} &
 \multicolumn{1}{l}{zmodyf. ReNet} & \multicolumn{1}{l}{l n} & \multicolumn{1}{l|}{drop} \\\cline{2-4} &
 \multicolumn{1}{l}{conv} & \multicolumn{1}{l}{l n} & \multicolumn{1}{l|}{drop} \\\hline
 \hline
 \multirow{3}{*}{\makecell{Flowers Recognition}} & 
 \multicolumn{1}{l}{ReNet} & \multicolumn{1}{l}{l n} & \multicolumn{1}{l|}{drop} \\\cline{2-4} &
 \multicolumn{1}{l}{zmodyf. ReNet} & \multicolumn{1}{l}{l n} & \multicolumn{1}{l|}{drop} \\\cline{2-4} &
...
W celu porównania nauczonych reprezentacji zmodyfikowanej i niezmodyfikowanej architektury ReNet przygotowano wizualizacje aktywacji przedostatniej warstwy sieci. Wektor wyjścia dla każdego przykładu ze zbioru testowego poddano redukcji wymiarowości do dwóch wymiarów. Umożliwia to przedstawienie każdego elementu zbioru testowego na płaszczyźnie z zaznaczeniem klasy, do której należy przykład. Do redukcji wymiarowości wybrano algorytmy PCA i tSNE (cite tSNE). Wyniki przedstawiono na rys. \ref{fig:tSNE_ReNet} i \ref{fig:tSNE_modif_ReNet}.
