...
\begin{table}[ht]
    \centering
    \caption{Porównanie osiągniętych p-wartości oraz F-wartości dla testu Friedmana dokładności wybranych klasyfikatorów}
    \input{tab/table_stats.tex}
    \label{table:cross_validation}
\end{table}

\begin{table}[ht]
    \centering
    \caption{Porównanie osiągniętych p-wartości dla testów post-hoc}
    \input{tab/table_post_hoc.tex}
    \label{table:cross_validation}
\end{table}
